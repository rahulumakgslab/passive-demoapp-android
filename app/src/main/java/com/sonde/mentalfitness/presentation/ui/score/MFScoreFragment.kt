...
import com.sonde.mentalfitness.presentation.ui.score.adapter.FeatureScoreAdapter
...
class MFScoreFragment : Fragment() {
    companion object {
        fun newInstance(sessionData: SubmitSessionModel, vfFinalScore: VFFinalScore) =
            MFScoreFragment().apply {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mf_screen, container, false)
    }
