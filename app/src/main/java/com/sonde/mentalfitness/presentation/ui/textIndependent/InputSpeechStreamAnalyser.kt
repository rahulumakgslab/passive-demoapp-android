...
import com.sonde.mentalfitness.presentation.ui.textIndependent.MicAudioRecorder.Companion.getAudioSize
...
class InputSpeechStreamAnalyser(
    ...
    @Volatile
    var analysingStatus = AnalysingStatus.Idle
        private set
    ...
    fun stopAnalysis() {
        ...
        analysingStatus = AnalysingStatus.Idle
