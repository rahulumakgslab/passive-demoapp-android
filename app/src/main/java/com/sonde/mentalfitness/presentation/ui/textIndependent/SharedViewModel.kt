...
import com.sonde.voip_vad.BiometricsType
import com.sonde.voip_vad.GlobalPrefs
import com.sonde.voip_vad.TemplateFileCreator
    ...
    */
    ...
    fun init(context: Context) {
        ...
        deferredVoiceTemplateFactories = viewModelScope.async(Dispatchers.Default) {
            mapOf(
                BiometricsType.TextIndependent to VoiceTemplateFactory(textIndependentInitData),
            )
        }

        deferredVoiceTemplateMatcher = viewModelScope.async(Dispatchers.Default) {
            mapOf(
                BiometricsType.TextIndependent to VoiceTemplateMatcher(textIndependentInitData),
            )
        }
