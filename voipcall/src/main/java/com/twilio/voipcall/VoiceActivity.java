...
import com.sonde.mentalfitness.presentation.utils.util.NetUtilsKt;
...
public class VoiceActivity extends AppCompatActivity implements OnWaveFileReadyListener {

    private static final String TAG = "VoiceActivity";
    private static final int MIC_PERMISSION_REQUEST_CODE = 1;
    private String accessToken;
//    private String accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..uMfE-26zcqserjjEMWL-0UTFIQZnQRwl72b50CyY_kU";
    //"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..fgT199USQ5ZDGV-BeBDoHtW8Pci3-MD_zbwy4icpTwA";
    //"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..14p_knltCwE5oKV3Um5ca48udL8kKDEl8wzsyI4Tcic";
    ...
    private FileAndMicAudioDevice fileAndMicAudioDevice;
    private String userName;
    private VoiceVideoModel viewModel;
    private static final String ARG_USER_NAME = "user_name";
    //    private CountDownTimer countDownTimer;
    private boolean isRecordingFinished = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(VoiceVideoModel.class);
        userName = getIntent().getStringExtra(ARG_USER_NAME);

        viewModel.getForceFetchSuccess().observe(this, success -> {
            if (success) {
                createNShowDialog();
...
//                if (fileAndMicAudioDevice != null) {
//                    isRecordingFinished = true;
//                    fileAndMicAudioDevice.stopCallRecording();
//                }
//            }
//        };
        ...
        if (!checkPermissionForMicrophone()) {
            ...
            viewModel.fetchAccessToken(userName, false);
        }

        fileAndMicAudioDevice = new FileAndMicAudioDevice(getApplicationContext());
        fileAndMicAudioDevice.setOnWaveFileReadyListener(this);
...
//                }
            ...
            public void onConnectFailure(@NonNull Call call, @NonNull CallException error) {
                ...
                fileAndMicAudioDevice.setCallConnected(false);
//                if (BuildConfig.playCustomRingback) {
...
//                }
            ...
            public void onConnected(@NonNull Call call) {
                ...
                fileAndMicAudioDevice.setCallConnected(true);
...
//                    registerForCallInvites();
    ...
    @Override
    public void onWavFileReady(@NotNull String waveFilePath) {
        Log.d("!!!!!", "waveFilePath====" + waveFilePath);
        Intent intent = WaveProcessService.Companion.newInstance(this, waveFilePath, "MALE",2000);
        WaveProcessService.Companion.enqueueWork(this, intent);
    }

    @Override
    public void onWavFileReadyForSegmentScore(@NonNull String waveFilePath, int segmentNumber) {

    }

    @Override
    public void onWavFileReadyForSegmentScore(@NonNull String waveFilePath) {
    ...
    private View.OnClickListener callActionFabClickListener() {
        return v -> {
            if (!NetUtilsKt.isNetworkAvailable()) {
                Toast.makeText(VoiceActivity.this, "No internet available", Toast.LENGTH_LONG).show();
                return;
            }
            if (viewModel.isAccessTokenFetched()) {
                createNShowDialog();
            } else {
                viewModel.fetchAccessToken(userName, true);
            }
        };
    }

    private void createNShowDialog() {
